                        ...
                        <div id="novedades" class="row pt-12 justify-center">
                            <div class="order-3 order-md-2 col-lg-7 col-xl-8 col-12">
                                ...
                                <div class="container">
                                    ...
                                    <div class="mt-4 subtitle-1">1. Imprima por pantalla: “Hola mundo”</div>
                                    <?php
                                    echo "Hola mundo";
                                    ?>
                                    <div class="mt-4 subtitle-1">2. Cargue en una variable la cadena de caracteres “Hola mundo” y luego la imprima por pantalla.</div>
                                    <?php
                                    $variable1 = "Hola mundo";
                                    echo $variable1;
                                    ?>
                                    <div class="mt-4 subtitle-1">3. Crear dos variables enteras y mostrar por pantalla, la suma, la resta, la multiplicación, la división
                                        entera y el resto de la división entera</div>
                                    <?php
                                    $numero1 = 2;
                                    $numero2 = 3;
                                    ...
                                    ?>
                                    <div class="mt-4 subtitle-1">4. Realizar la transformación de grados Celsius a Fahrenheit, para el valor 20°C y luego lo imprima por pantalla.</div>
                                    <?php
                                    ...
                                    ?>
                                    <div class="mt-4 subtitle-1">5. Implementar algoritmos que permitan</div>
                                    <div class="mt-4 subtitle-1">a) Calcular el perímetro y el área de un rectángulo, dado que su base es 18cm y su altura 12cm.</div>
                                    <?php
                                    $base = 18;
                                    $altura = 12;
                                    ...
                                    ?>
                                    <div class="mt-4 subtitle-1">b) Calcular el perímetro y el área de un círculo dado que su radio es de 30cm.</div>
                                    <?php
                                    $radio = 30;
