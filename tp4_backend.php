                        ...
                        <div id="novedades" class="row pt-12 justify-center">
                            <div class="order-3 order-md-2 col-lg-7 col-xl-8 col-12">
                                ...
                                <div class="container">
                                    ...
                                    <hr role="separator" aria-orientation="horizontal" class="w-2 mt-1 v-divider theme--light" />
                                    <?php
                                    echo '<div class="headline">Login</div>';
                                    echo '<div class="mt-2 subtitle-1">Crear un Login que valide usuario y contraseña y redirija a una dirección en caso de true y a otra en caso de false.</div>';
                                    ?>
                                    <br>
                                    <img src="./img/tp04.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
